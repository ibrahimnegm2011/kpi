                            ...
                            <div class="w-full pt-3">
                                <div class="flex items-center dark:border-gray-700">
                                    <input id="permission-check-{{$i}}" type="checkbox" value="{{$case->value}}"
                                           ...
                                           class="permission-checkbox w-7 h-7 text-emerald-400 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
