        ...
        <div class="flex justify-between mb-5">
            ...
            <div class="flex gap-3">
                <a class="bg-secondary-500 hover:bg-secondary-700 text-white font-bold py-2 px-4 rounded"
                   href="{{route('account.departments.create')}}">Add Department</a>
            </div>
        </div>
                ...
                @foreach($departments as $department)
                    <tr class="hover:bg-gray-100">
                        ...
                        <td class="py-4 px-6 border-b border-grey-light ">
                            <a class="mx-2 text-secondary-500 hover:text-primary-500" href="{{route('account.departments.edit', $department->id)}}"> <i class="fas fa-edit"></i> </a>
                            <form method="POST" action="{{ route('account.departments.delete', $department) }}" style="display:inline;"
