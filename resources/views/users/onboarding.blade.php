<x-guest-layout>
    <p class="text-gray-600 text-lg font-bold mb-6 text-center">Complete your Registration</p>

    <form method="POST" action="{{ route('users.onboarding', $user) }}" class="w-full space-y-4">
        @csrf
        <div>
