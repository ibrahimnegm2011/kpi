        ...
        <div class="flex justify-between mb-5">
            ...
            <div class="flex gap-3">
                <a class="bg-secondary-500 hover:bg-secondary-700 text-white font-bold py-2 px-4 rounded"
                   href="{{route('forecasts.create')}}">Add Forecast</a>
            </div>
        </div>
                ...
                @forelse($forecasts as $forecast)
                    <tr class="hover:bg-gray-100">
                        ...
                        <td class="py-4 px-6 border-b border-grey-light ">
                            <a class="mx-1 text-secondary-500 hover:text-primary-500" href="{{route('forecasts.view', $forecast->id)}}"> <i class="fas fa-eye"></i> </a>
                            @if(!$forecast->is_submitted)
                                <a class="mx-1 text-secondary-500 hover:text-primary-500" href="{{route('forecasts.edit', $forecast->id)}}"> <i class="fas fa-edit"></i> </a>
                                <form method="POST" action="{{ route('forecasts.delete', $forecast) }}" style="display:inline;"
                            ...
                            @else
                                @if($forecast->evidence_filepath)
                                    <a class="mx-1 text-secondary-500 hover:text-primary-500" href="{{route('forecasts.download', $forecast)}}" target="_blank">
