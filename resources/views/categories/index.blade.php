                ...
                @foreach($categories as $category)
                    <tr class="hover:bg-gray-100">
                        ...
                        <td class="py-4 px-6 border-b border-grey-light ">
                            <a class="mx-2 text-secondary-500 hover:text-primary-500" href="{{route('categories.edit', $category->id)}}"> <i class="fas fa-edit"></i> </a>
                            <form method="POST" action="{{ route('categories.delete', $category) }}" style="display:inline;"
