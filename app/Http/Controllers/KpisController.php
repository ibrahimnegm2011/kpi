...
class KpisController extends Controller
{
    ...
    public function form(?Kpi $kpi = null)
    {
        ...
        return view('kpis.form', compact('kpi'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect(route('kpis.index'))->with(['success' => 'Kpi has been created successfully']);
    }
    ...
    public function update(Kpi $kpi, Request $request)
    {
        ...
        return redirect(route('kpis.index'))->with(['success' => 'Kpi has been updated successfully']);
    }
    ...
    public function delete(Kpi $kpi)
    {
        ...
        return redirect(route('kpis.index'))->with(['success' => 'Kpi has been deleted successfully.']);
    }

    public function byCategory(Category $category)
    {
        return response()->json(Kpi::where('category_id', $category->id)->get(['id', 'title']));
    }
}
