...
class KpisController extends Controller
{
    ...
    {
        return view('representative.kpis.index', [
    ...
    {
        return view('representative.kpis.overdue', [
            'forecasts' => QueryBuilder::for(Forecast::class)->allowedFilters([
                AllowedFilter::exact('category', 'kpi.category_id'),
                AllowedFilter::exact('year', 'year'),
                AllowedFilter::exact('month', 'month'),
    ...
    {
        return view('representative.kpis.submitted', [
            'forecasts' => QueryBuilder::for(Forecast::class)->allowedFilters([
                AllowedFilter::exact('category', 'kpi.category_id'),
                AllowedFilter::exact('year', 'year'),
                AllowedFilter::exact('month', 'month'),
    ...
    {
        return view('representative.kpis.form', compact('forecast'));
    }
